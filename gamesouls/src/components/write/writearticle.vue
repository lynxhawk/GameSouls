	...
	<v-container>
		<v-row justify="center" width="800px" class="mt-6">
			<v-card style="width: 800px;" class="px-6" tile>
				<v-row>
				<v-text-field prepend-icon="mdi-format-title" color="green" clearable label="文章标题"></v-text-field>
				<v-btn color="green" text tile height="50" width="70" class="ml-2">
					<strong>提交</strong></v-btn>
				</v-row>
				<v-row>
				<v-text-field color="green" prepend-icon="mdi-subtitles-outline" clearable label="摘要"></v-text-field>
				</v-row>
				<v-row>
